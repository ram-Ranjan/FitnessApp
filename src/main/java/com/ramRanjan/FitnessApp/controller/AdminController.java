...
public class AdminController {
	...
	@ApiResponse(code = 400, message = "Email not found for the given adminEmail") })
	@GetMapping("/login")
	public ResponseEntity<ResponseStructure<AdminDto>> findAdminByEmailAndPassword(@Valid @RequestParam String adminEmail,@Valid @RequestParam String adminPassword) 
	{
