...
public class CustomerController 
{
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "succesfully Saved"),
			@ApiResponse(code = 400, message = "Id not found for the given Customer ID") })
	@PutMapping
	public ResponseEntity<ResponseStructure<CustomerDto>> updateCustomer(@Valid  @RequestParam int customerId,@RequestBody Customer customer)
	{
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "succesfully Found"),
			@ApiResponse(code = 400, message = "Id not found for the given Customer ID") })
	@GetMapping("/email")
	public ResponseEntity<ResponseStructure<CustomerDto>> findCustomerByEmail(@Valid @RequestParam String customerEmail)
	{
